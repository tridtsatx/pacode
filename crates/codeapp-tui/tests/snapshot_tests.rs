...
fn make_base_snapshot() -> SessionSnapshot {
    ...
    let cwd = PathBuf::from(home).join("zed/codeapp");
    ...
    let agents = vec![
        ...
        AgentInfo {
            ...
            kind: AgentKind::Sub,
            status: AgentStatus::RunningTool,
            activity: Some("cargo test -p codeapp-tui".into()),
    ...
    let transcript = vec![
        ...
        TranscriptItem {
            ...
            kind: TranscriptKind::ToolCall {
                call_id: "call_1".into(),
                name: "read_file".into(),
                title: "crates/codeapp-tui/src/layout.rs".into(),
                intent: None,
    ...
    let panel_items = vec![
        ...
        TranscriptItem {
            ...
            kind: TranscriptKind::ToolCall {
                ...
                name: "edit_file".into(),
                title: "crates/codeapp-tui/src/ui/rail.rs".into(),
                intent: None,
                status: ToolStatus::Ok,
                preview: "--- a/rail.rs\n+++ b/rail.rs\n@@ -10,3 +10,5 @@\n+use ratatui::Frame;\n-old_code();\n+new_code();\n".into(),
