...
use codeapp_client::{Client, ClientEvent};
use codeapp_types::state::ToastLevel;
use codeapp_types::time::now_ms;
use codeapp_types::{AgentId, Reply, Request, TranscriptKind};
...
enum BgResponse {
    Reply(Result<Reply, codeapp_client::ClientError>),
    LoadPanelReply {
        target: PanelTarget,
        result: Result<Reply, codeapp_client::ClientError>,
    },
    LoadHistoryReply {
        result: Result<Reply, codeapp_client::ClientError>,
    },
