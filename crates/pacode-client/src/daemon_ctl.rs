//! Daemon lifecycle helpers used by `pacode daemon status|stop` and by autospawn.

use std::path::{Path, PathBuf};

use pacode_types::ids::ClientId;
use pacode_types::{ClientHello, Envelope, PROTOCOL_VERSION, Reply, Request, ServerMessage};
