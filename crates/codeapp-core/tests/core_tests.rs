...
use codeapp_core::core::{Core, CoreDeps};
...
use codeapp_tools::{AgentSpec, Tool, ToolCtx, ToolError, ToolKind, ToolOutput, ToolRegistry};
use codeapp_types::{
...
async fn setup_test_core() -> (Arc<Core>, Arc<MockProvider>, tempfile::TempDir) {
    ...
    let exec_cfg = codeapp_types::ExecConfig {
        yield_after_secs: 1,
        stall_secs: 100,
