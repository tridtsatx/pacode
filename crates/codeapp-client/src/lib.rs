//! Daemon connection for frontends (TUI, `codeapp run`, `codeapp sessions`).
//!
...
use codeapp_types::{Attach, Event, Reply, Request, SessionId, SessionSnapshot};
use tokio::sync::mpsc;
...
pub use codeapp_types::{Attach as AttachRequest, Reply as WireReply, Request as WireRequest};
